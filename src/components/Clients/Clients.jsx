...
const Clients = () => {
  const companies = [
    {
      ...
      technologies:
        "Data Science | Data Analytics | Data Visualization | Predictive Maintenance | IoT | Machine Learning",
    },
    {
      company: "Idwall",
      description:
  ...
  return (
    <section id="clients" className="clients">
      <div className="clients_content-title">
        <h2>Clients</h2>
        <span>Here you will find some companies that we worked for</span>
      </div>
      <div className="clients_content-job">
        {companies.map((company) => (
          <div className="clients_content-job-card">
            <div className="clients_content-job-card-header">
              <h2>{company.company}</h2>
            </div>
            <span className="clients_content-job-card-desc">
              {company.description}
            </span>
            <span className="clients_content-job-card-tech">
      ...
      <div className="clients_content-title">
        <h2>Most used Techs</h2>
      </div>
      <div className="clients_content-techs">
        <img
          className="clients_content-techs-image"
